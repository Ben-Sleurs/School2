...
namespace MVCBibliotheekBENSLE.Controllers
{
    public class GebruikersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GebruikerId,Voornaam,Achternaam,IdentityUserId")] Gebruiker gebruiker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("GebruikerId,Voornaam,Achternaam,IdentityUserId")] Gebruiker gebruiker)
        {
