...
namespace PXLFilmzaal.Controllers
{
    public class FilmsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmId,FilmNaam,FilmImageId")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("FilmId,FilmNaam,FilmImageId")] Film film)
        {
            if (id != film.FilmId)
            {
                return NotFound();
