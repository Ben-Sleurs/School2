...
namespace HogeschoolPXL.Migrations
{
    ...
    [Migration("20221217181523_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.AcademieJaar", b =>
                {
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Gebruiker", b =>
                {
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Handboek", b =>
                {
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Inschrijving", b =>
                {
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Lector", b =>
                {
                    ...
                    b.HasIndex("GebruikerId")
                        .IsUnique()
                        .HasFilter("[GebruikerId] IS NOT NULL");

                    b.ToTable("Lector");
                });

            modelBuilder.Entity("HogeschoolPXL.Models.Data.Student", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Vak", b =>
                {
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.VakLector", b =>
                {
                    b.Property<int>("VakLectorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Inschrijving", b =>
                {
                    b.HasOne("HogeschoolPXL.Models.Data.AcademieJaar", "AcademieJaar")
                        .WithMany("Inschrijvingen")
                        .HasForeignKey("AcademieJaarId");

                    b.HasOne("HogeschoolPXL.Models.Data.Student", "Student")
                        .WithMany("Inschrijvingen")
                        .HasForeignKey("StudentId");

                    b.HasOne("HogeschoolPXL.Models.Data.VakLector", "VakLector")
                        .WithMany("Inschrijvingen")
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Lector", b =>
                {
                    b.HasOne("HogeschoolPXL.Models.Data.Gebruiker", "Gebruiker")
                        .WithOne("Lector")
                        .HasForeignKey("HogeschoolPXL.Models.Data.Lector", "GebruikerId");
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Student", b =>
                {
                    b.HasOne("HogeschoolPXL.Models.Data.Gebruiker", "Gebruiker")
                        .WithOne("Student")
                        .HasForeignKey("HogeschoolPXL.Models.Data.Student", "GebruikerId");
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.Vak", b =>
                {
                    b.HasOne("HogeschoolPXL.Models.Data.Handboek", "Handboek")
                        .WithMany("Vakken")
            ...
            modelBuilder.Entity("HogeschoolPXL.Models.Data.VakLector", b =>
                {
                    b.HasOne("HogeschoolPXL.Models.Data.Lector", "Lector")
                        .WithMany("VakLectors")
                        .HasForeignKey("LectorId");

                    b.HasOne("HogeschoolPXL.Models.Data.Vak", "Vak")
                        .WithMany("VakLectors")
                        .HasForeignKey("VakId");
